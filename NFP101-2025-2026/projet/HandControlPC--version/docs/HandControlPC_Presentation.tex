    ...
    \begin{column}{0.52\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        cbox/.style={rectangle, draw=cnamblue, fill=cnamblue!8, rounded corners=3pt,
                     minimum width=2.6cm, minimum height=0.75cm, align=center, font=\scriptsize\ttfamily},
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Choix cl\'es}
        \begin{itemize}
          ...
          \item Principe \textbf{Open/Closed} : ajouter un mode = une sous-classe.
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}{Utilisation de l'IA --- transparence}
  \begin{block}{IA utilis\'ee~: Claude Code (Anthropic)}
    Code g\'en\'er\'e/assist\'e encadr\'e par \texttt{\# CODE IA (Claude)} dans les sources.
  \end{block}
  \vspace{0.2cm}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \textbf{O\`u l'IA a aid\'e}
      \begin{itemize}
        \item Classe abstraite \texttt{GestureAction}
        \item Refactorisation h\'eritage
        \item Loader config + tests
        \item Documentation
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
  ...
  \vspace{0.2cm}
  \begin{center}
    \textbf{Taux d'utilisation estim\'e~: $\approx$ 40\,\%} (architecture, tests, doc)
  \end{center}
\end{frame}
...
\begin{frame}{Bibliographie et r\'ef\'erences}
  ...
  \begin{block}{Intelligence artificielle}
    \begin{itemize}
      \item \textbf{Claude Code} (Anthropic) --- assistance architecture, tests, documentation
    \end{itemize}
  \end{block}
\end{frame}
