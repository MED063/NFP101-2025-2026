...
{\large Professeur~: \textbf{M. Adrien Escourrou}}\\[2.5cm]
...
\subsection{Marqueurs dans les fichiers sources}
...
\begin{itemize}
  ...
  \item \textbf{\texttt{main.py}}~: refactorisation assist\'ee légeremment par Github copilot .
\end{itemize}
\end{iabox}
