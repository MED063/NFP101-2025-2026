...
import subprocess  # Feedback sonore 
...
def main():
    ...
    cooldown_frames = 0  
    CUSTOM_IMAGE_PATH = "utils/logo.png/logo.png"  
                    ...
                    if hands_data:
                        ...
                        if confidence_level >= 0.6 and screenshot_cooldown == 30:
                            if screenshot.capture():
                                subprocess.Popen(["afplay", "/System/Library/Sounds/Tink.aiff"])  # Feedback sonore macOS
